...
/***/ function(module, exports, __webpack_require__) {
	...
	window.SimpleForm = __webpack_require__(1);
	...
	var SimpleForm = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement('input', { type: 'text', name: 'email', className: this.state.errorClass, onChange: this.handleEmailChange, value: this.state.email }),
	            React.createElement('input', { type: 'password', name: 'password', onChange: this.handlePasswordChange, value: this.state.password }),
